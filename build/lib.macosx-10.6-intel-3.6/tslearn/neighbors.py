...
from tslearn.metrics import cdist_dtw, min_dist_matrix, euclidean_multivar_matrix, dtw_multivar_matrix
...
class KNeighborsTimeSeries(KNeighborsTimeSeriesMixin, NearestNeighbors):
    ...
    (3, 2)
    """
    def __init__(self, n_neighbors=1, metric="dtw", metric_params=None):
    ...
    def kneighbors(self, X=None,variables_size=1, n_neighbors=None, return_distance=True):
        ...
        return KNeighborsTimeSeriesMixin.kneighbors(self,
                                                    X=X,variables_size=variables_size,
